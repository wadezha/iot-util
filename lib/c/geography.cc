...
double aa(double d1, double d2) {
	...
	return d3 = (d3 = (d3 = (d3 = 300 + 1.0 * d1 + 2 * d2
		+ 0.10000000000000001 * d1 * d1 + 0.10000000000000001 * d1 * d2 + 0.10000000000000001 *sqrt(sqrt(d1 * d1)))
		+ (20 * a(18.849555921538759 * d1) + 20 * a(6.2831853071795862 * d1)) * 0.66669999999999996)
		+ (20 * a(3.1415926535897931 * d1) + 40 * a((3.1415926535897931 * d1) / 3)) * 0.66669999999999996)
		+ (150 * a((3.1415926535897931 * d1) / 12) + 300 * a((3.1415926535897931 * d1) / 30)) * 0.66669999999999996;
}

double bb(double d1, double d2) {
	double d3;
	return d3 = (d3 = (d3 = (d3 = -100 + 2 * d1 + 3 * d2
		+ 0.20000000000000001 * d2 * d2 + 0.10000000000000001 * d1 * d2 + 0.20000000000000001 * sqrt(sqrt(d1 * d1)))
		+ (20 * a(18.849555921538759 * d1) + 20 * a(6.2831853071795862 * d1)) * 0.66669999999999996)
		+ (20 * a(3.1415926535897931 * d2) + 40 * a((3.1415926535897931 * d2) / 3)) * 0.66669999999999996)
		+ (160 * a((3.1415926535897931 * d2) / 12) + 320 * a((3.1415926535897931 * d2) / 30)) * 0.66669999999999996;
}
double cc(double d1, double d2) {
	double d3 = a((d1 * 3.1415926535897931) / 180);
	double d4 = sqrt(1.0 - 0.0066934200000000003 * d3 * d3);
	return d4 = (d2 * 180) / ((6378245 / d4) * cos((d1 * 3.1415926535897931) / 180) * 3.1415926535897931);
}
